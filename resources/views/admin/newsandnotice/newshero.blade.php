...
@section('content')
    @include('components.breadcrumb', [
        'breadcrumbs' => [
            ...
            ['title' => 'Create News Hero', 'url' => null],
        ],
    ])
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-xl font-semibold text-gray-800">Create News Hero</h1>
        ...
        <form action="{{ route('newshero.store', $organization->slug) }}" method="POST">
            @csrf
            <div class="space-y-3">
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}"
                            placeholder="Enter News Hero title"
