...
@section('content')
    @include('components.breadcrumb', [
        'breadcrumbs' => [
            ...
            ['title' => 'Edit HomeMission', 'url' => null],
        ],
    ])
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-xl font-semibold text-gray-800">Edit Homemissions</h1>
        ...
        <form action="{{ route('homemission.update', [$organization->slug, $homemission->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-3">
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $homemission->title) }}"
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="hidden" name="content" id="content"
                            value="{{ old('content', $homemission->content) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 my-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-col items-center justify-center p-4 border border-dashed border-gray-300 rounded-md">
                        <input type="hidden" name="image_1" id="image_1" value="{{ old('image_1', $homemission->media_id_1) }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-col items-center justify-center p-4 border border-dashed border-gray-300 rounded-md">
                        <input type="hidden" name="image_2" id="image_2" value="{{ old('image_2', $homemission->media_id_2) }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-col items-center justify-center p-4 border border-dashed border-gray-300 rounded-md">
                        <input type="hidden" name="image_3" id="image_3" value="{{ old('image_3', $homemission->media_id_3) }}">
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_home" id="is_home" value="1" @checked(old('is_home', $homemission->is_home))
...
@push('scripts')
    <script>
        ...
        @if($homemission->media1)
            loadExistingImage(1, {{ $homemission->media_id_1 }}, '{{ $homemission->media1->url ?? '' }}');
        @endif
        @if($homemission->media2)
            loadExistingImage(2, {{ $homemission->media_id_2 }}, '{{ $homemission->media2->url ?? '' }}');
        @endif
        @if($homemission->media3)
            loadExistingImage(3, {{ $homemission->media_id_3 }}, '{{ $homemission->media3->url ?? '' }}');
        @endif
