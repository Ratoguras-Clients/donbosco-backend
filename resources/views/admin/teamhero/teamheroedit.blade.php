...
@section('content')
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-xl font-semibold text-gray-800">Edit Team Hero</h1>
        ...
        <form action="{{ route('teamhero.update', [$organization->slug, $teamhero->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-3">
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $teamhero->title) }}"
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="hidden" name="content" id="content"
                            value="{{ old('content', $teamhero->content) }}">
                    </div>
                </div>
            </div>

            <div class="flex items-center mt-6">
                <input type="checkbox" name="is_home" id="is_home" value="1" @checked(old('is_home', $teamhero->is_home))
