...
<div class="bg-white p-6 rounded-lg shadow-sm mb-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-semibold text-gray-800">Edit blog</h1>
    ...
    <form action="{{ route('blog.update', ['slug' => $organization->slug, 'id' => $blog->id]) }}" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" name="name" id="name"
                        value="{{ old('name', $blog->name) }}" placeholder="Venue or address"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="start_date" id="start_date" value="{{ old('start_date',$blog->start_date->format('Y-m-d')) }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_home" id="is_home" value="1"
                        {{ old('is_home', $blog->is_home) ? 'checked' : '' }}
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6">
                ...
                <div
                    class="flex flex-col items-center justify-center p-4 border border-dashed border-gray-300 rounded-md">
                     <input type="hidden" name="media_id" id="image" value="{{ $blog->media_id }}">


                    <!-- Existing image preview -->
                    @if ($blog->media)
                    <div id="featured-image-preview" class="mb-4 text-center">
                        <img src="{{ $blog->media->url }}" alt="Current image"
                    ...
                    <button type="button" id="select-featured-image"
                        ...
                        {{ $blog->media ? 'Change Image' : 'Select Image' }}
                    </button>

                    <button
                        type="button"
                        id="remove-featured-image"
                        class="text-red-600 hover:text-red-800 text-sm mt-2 flex items-center {{ $blog->media ? '' : 'hidden' }}">
...
<script>
    ...
    descriptionQuill.root.innerHTML = `{!! addslashes($blog->description) !!}`;
