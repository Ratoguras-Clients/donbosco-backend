...
<div class="bg-white p-6 rounded-lg shadow-sm mb-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-semibold text-gray-800">Create Message</h1>
    ...
    <form action="{{ route('messages.store', $organization->slug) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    <button type="button" id="staffRoleTrigger"
                        ...
                        <span id="selectedRoleText" class="text-gray-700">Select Staff</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="tenure" id="tenure" value="{{ old('tenure') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 pb-4 gap-6">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_home" id="is_home" value="1" {{ old('is_home', 1) ? 'checked' : '' }}
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
...
<script>
    ...
    $(document).on('click', function(e) {
        if (!$(e.target).closest('#staffRoleTrigger, #staffRoleDropdown, label[for="staffRoleTrigger"]')
            .length) {
