...
<div class="bg-white p-6 rounded-lg shadow-sm mb-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-semibold text-gray-800">Edit News</h1>
        ...
        <div class="space-y-3">
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6">
                ...
                <div
                    ...
                    <input type="hidden" name="image" id="image" value="{{ $news->media_id }}">

                    <!-- Existing image preview -->
                    @if ($news->media)
                    <div id="featured-image-preview" class="mb-4 text-center">
                        <img src="{{ $news->media->url }}" alt="Current image"
                    ...
                    <button type="button" id="select-featured-image"
                        ...
                        {{ $news->media ? 'Change Image' : 'Select Image' }}
                    </button>
                    ...
                    <button
                        ...
                        class="text-red-600 hover:text-red-800 text-sm mt-2 flex items-center {{ $news->media ? '' : 'hidden' }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_home" id="is_home" value="1"
                        {{ old('is_home', $news->is_home) ? 'checked' : '' }}
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
...
<x-media-piker modalId="featured-image-media-picker" title="Select or Upload Image" :allowMultiple="false"
    ...
    {{-- :initialSelection="{{ $news->media_id ?? 'null' }}" --}} acceptedTypes="image/jpeg,image/jpg,image/png,image/gif,image/webp,image/svg+xml"
    maxFileSize="10MB" />
@endsection
...
<script>
    ...
    summaryQuill.root.innerHTML = `{!! addslashes($news->summary) !!}`;
    ...
    contentQuill.root.innerHTML = `{!! addslashes($news->content) !!}`;
