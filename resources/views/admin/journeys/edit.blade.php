...
@section('content')
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-xl font-semibold text-gray-800">Edit Journey</h1>
        ...
        <form action="{{ route('journeys.update', ['slug' => $organization->slug, 'id' => $journey->id]) }}" method="POST"
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $journey->title) }}"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5"
                        class="block w-full p-3 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white">{{ old('description', $journey->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="start_date" id="start_date"
                                value="{{ old('start_date', $journey->start_date?->format('Y-m-d')) }}" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="end_date" id="end_date"
                                value="{{ old('end_date', $journey->end_date?->format('Y-m-d')) }}"
                                class="date w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-800 focus:border-blue-800">
                        </div>
                        @error('end_date')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <div class="flex flex-col items-center justify-center p-4 border border-dashed border-gray-300 rounded-md">
                                ...
                                <button type="button" class="select-image-btn px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-md border border-gray-300 dark:border-gray-600 flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-600 transition"
                                    ...
                                    {{ $journey->media ? 'Change Image 1' : 'Select Image 1' }}
                                </button>

                                <button type="button" class="remove-image-btn text-red-600 hover:text-red-800 text-sm mt-2 flex items-center {{ $journey->media ? '' : 'hidden' }}"
                                    data-image-number="1">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col items-center justify-center p-4 border border-dashed border-gray-300 rounded-md">
                                        ...
                                        <div class="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm overflow-hidden">
                                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                                                <div class="flex items-center gap-2">
                                                    <span class="iconify text-green-500" data-icon="tabler:photo" data-width="18"></span>
                                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300 truncate max-w-[240px]">
                                                        {{ basename($journey->media2->url) }}
                                                    </span>
                                                </div>
                                                <button type="button" class="remove-image-inline text-red-600 dark:text-red-400 hover:text-red-800 text-xs px-2 py-1 rounded"
                                                    data-image-number="2">Remove</button>
                                            </div>
                                            <div class="flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-700/50 min-h-[120px]">
                                                <img src="{{ $journey->media2->url }}" alt="Cover Image 2"
                                                    class="max-w-full h-48 object-contain rounded-md shadow-sm">
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <button type="button" class="select-image-btn px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-md border border-gray-300 dark:border-gray-600 flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-600 transition"
                                    data-image-number="2">
                                    <span class="iconify mr-2" data-icon="tabler:upload" data-width="20"></span>
                                    {{ $journey->media2 ? 'Change Image 2' : 'Select Image 2' }}
                                </button>

                                <button type="button" class="remove-image-btn text-red-600 hover:text-red-800 text-sm mt-2 flex items-center {{ $journey->media2 ? '' : 'hidden' }}"
                                    data-image-number="2">
                                    <span class="iconify mr-2" data-icon="tabler:trash" data-width="16"></span>
                                    Remove Image
                                </button>
