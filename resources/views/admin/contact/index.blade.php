        ...
        <div
            ...
            <div class="premium-card-title flex items-center mb-4 md:mb-0">
                ...
                <div class="header-text">
                    <h4 class="text-lg font-semibold text-gray-800 dark:text-white">Contacts Management</h4>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Manage all Contacts in the system</p>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() {
                ...
                "columns": [{
                    ...
                    },
                    {
                        "data": function(row) {
                            return `
                                <div class="flex items-center">
                                    <span class="font-semibold">${row.email}</span>
                    ...
                    },
                    {
                        "data": function(row) {
                            return `
                                <div class="flex items-center">
                                    <span class="font-semibold">${row.phone}</span>
                    ...
                    {
                        "data": function(row) {
                            var plainText = $('<div>').html(row.message).text();
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                nepalConfirm.show({
                    ...
                    const url = "{{ route('contact.destroy', ':id') }}".replace(':id', id);
                    $.ajax({
                        url: url,
                        type: "DELETE",
                        data: {
