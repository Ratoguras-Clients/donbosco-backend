...
<div class="bg-white p-6 rounded-lg shadow-sm mb-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-semibold text-gray-800">
            Edit Staff for {{ $organization->name }}
        </h1>
    ...
    <form
        action="{{ route('organization-staff.update', [
        ...
        <div class="space-y-3">
            ...
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $staff->name) }}"
                        placeholder="Enter Staff name" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md">
                </div>
                @error('name')
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="hidden" name="staff_role_id" id="staff_role_id"
                        value="{{ old('staff_role_id', $staff->getStaffRole->staff_role_id) }}">
                    ...
                    <div class="relative">
                        <button type="button" id="staffRoleTrigger"
                            ...
                            <span id="selectedRoleText" class="text-gray-700">
                                {{ $staff->getStaffRole->getRole[0]->name ?? 'Select Staff Role' }}
                            </span>

                            <span class="iconify text-gray-400" data-icon="tabler:chevron-down" data-width="18"></span>
                        </button>

                        <!-- Left icon (consistent with other fields) -->
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6">
                ...
                <div
                    ...
                    <input type="hidden" name="image" id="image" value="{{ old('image', $staff->media_id) }}">

                    @php
                    $existingImageUrl = $staff->media ? $staff->media->url : null;
                    @endphp


                    {{-- Static preview shown on page load if image exists --}}
                    <div id="featured-image-preview" class="{{ $existingImageUrl ? '' : 'hidden' }} mb-4 w-full">
                        @if ($existingImageUrl)
                        <div
                            class="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm overflow-hidden w-full max-w-md mx-auto">
                            <div
                                class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 border-b">
                                <div class="flex items-center gap-2 truncate">
                                    <span class="iconify text-green-500" data-icon="tabler:photo"
                                        data-width="18"></span>
                                    <span
                                        class="text-sm font-medium truncate">{{ basename($existingImageUrl) }}</span>
                                </div>
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 flex justify-center">
                                <img src="{{ $existingImageUrl }}" alt="Staff Image"
                    ...
                    {{-- Dynamic preview for newly selected images --}}
                    ...
                    <button type="button" id="select-featured-image"
                        ...
                        {{ $existingImageUrl ? 'Change Image' : 'Select Image' }}
                    </button>

                    <!-- Remove button (shown when image selected via JS) -->
        ...
        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit"
                    ...
                    <span class="iconify mr-2" data-icon="tabler:edit" data-width="18"></span>
                    Update
                </button>
            </div>
        </div>
...
<script>
    ...
    function modelOpen() {
        $('#custom-modal').show();
        // Use modal-specific IDs to avoid conflict with the main form's #name
    ...
    function updateImagePreview(url) {
        ...
        // Hide the server-rendered static preview and show the dynamic one
    ...
    $(document).ready(function() {
        ...
        // Callback when image is selected from media picker
        ...
        // Remove image — server-rendered preview
        $(document).on('click', '#remove-existing-image', clearImage);

        // Remove image — JS dynamic preview
    ...
    bioQuill.root.innerHTML = `{!! addslashes($staff->bio) !!}`;
        ...
        <form class="mt-4 mb-0" id="staff-role-form">
            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
                <div class="col-span-2">
                    {{-- Use unique IDs so they don't clash with the main form's #name --}}
