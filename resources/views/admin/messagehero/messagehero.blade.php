...
@section('content')
    @include('components.breadcrumb', [
        'breadcrumbs' => [
            ...
            ['title' => 'Create Message Hero', 'url' => null],
        ],
    ])
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-xl font-semibold text-gray-800">Create Message Hero</h1>
        ...
        <form action="{{ route('messagehero.store', $organization->slug) }}" method="POST">
            @csrf
            <div class="space-y-3">
